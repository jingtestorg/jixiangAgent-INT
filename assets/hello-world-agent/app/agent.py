...
def get_system_prompt() -> str:
    base_prompt = """You always respond with exactly the text: Hello World\n\nRegardless of what the user says, always respond with Hello World.""" + _DEFENSIVE_PROMPT_SUFFIX
...
class SampleAgent:
    ...
    @tracer.start_as_current_span("hello_world_response")
    async def _run_agent(
        ...
        """Execute agent and return the response string with business instrumentation."""
    ...
    async def stream(
        ...
        logger.info("M1.achieved: agent bootstrapped successfully")
        ...
        try:
            ...
            logger.error("M2.missed: response did not match expected value")
            yield {
                "is_task_complete": True,
                "require_user_input": False,
